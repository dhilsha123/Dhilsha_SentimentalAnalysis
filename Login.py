...
def login():
        ...
        sbmitbtn = Button(top, text="Cancel", activebackground="pink", font=large_font, activeforeground="blue",
                          command=top.destroy).place(x=300, y=130)

        sbmitbtn = Button(top, text="Submit", activebackground="pink", font=large_font, activeforeground="blue",
                          command=checkuser).place(x=200, y=130)
